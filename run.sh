...
python3 regret_new.py coci hoeffdingSingle boundedC bandit
echo "finished C"
...
python3 regret_new.py coci hoeffdingSingle boundedB bandit
echo "finished B"
...
python3 regret_new.py coci hoeffdingSingle boundedA bandit
echo "finished A"
