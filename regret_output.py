...
def output_bandit(name):
    samples_greedy, widths_greedy, correct_greedy = load_data("bandit", "workshop", name)
    #samples_greedySingle, widths_greedySingle, correct_greedySingle = load_data("bandit", "workshopSingle", name)
    ...
    #plt.plot(widths_greedySingle, label="SAUCB-Single", color="green", linestyle="--")
    ...
    #plt.bar(np.arange(S) + 1 - 0.1, (samples_greedySingle[-1] - 1)/T, width=0.2, label="SAUCB-Single", color="green")
    ...
    #plt.plot(correct_greedySingle, label="SAUCB-Single", color="green", linestyle="--")
