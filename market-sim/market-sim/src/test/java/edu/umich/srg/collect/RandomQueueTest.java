...
public class RandomQueueTest {
  ...
  public void collectionConstructorTest() {
    ...
    RandomQueue<Integer> a = RandomQueue.withElements(numbers);
  ...
  public void randomSeedTest() {
    ...
    RandomQueue<Integer> c = RandomQueue.withSeed(new Random(seed));
    c.addAll(numbers);
  ...
  public void clearTest() {
    RandomQueue<Integer> a = RandomQueue.withElements(randomNumbers(10));
  ...
  public void removeTest() {
    RandomQueue<Integer> a = RandomQueue.withElements(Ints.asList(1, 2, 3, 4, 5));
  ...
  public void offerPermutationTest() {
    ...
    for (int i = 0; i < 1000; i++) {
      RandomQueue<Integer> a = RandomQueue.withElements(randomNumbers(1000));
      a.add(0);
      if (a.peek() != 0)
        return;
    }
  ...
  public void offerNonpermutationTest() {
    ...
    for (int i = 0; i < 10000; i++) {
      RandomQueue<Integer> a = RandomQueue.withElements(randomNumbers(1));
      a.add(0);
      if (a.peek() == 0)
        return;
    }
