...
public class YSYLAgent implements Agent {
  ...
  public YSYLAgent(Sim sim, Market market, Fundamental fundamental, Spec spec, Random rand) {
    this.sim = sim;
  ...
  public static YSYLAgent createFromSpec(Sim sim, Fundamental fundamental,
      Collection<Market> markets, Market market, Spec spec, Random rand) {
    return new YSYLAgent(sim, market, fundamental, spec, rand);
  }
